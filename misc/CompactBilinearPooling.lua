...
function CompactBilinearPooling:__init(outputSize, path_name,homogeneous)
...
function CompactBilinearPooling:sample()
   file_path = 'save/bcp_params_' .. self.path_name .. '.t7'
   if(file_exists(file_path)) then
       ...
       torch.save('save/bcp_params_' .. self.path_name .. '.t7', {h1=self.h1, h2=self.h2, s1=self.s1, s2=self.s2})
    end
end
