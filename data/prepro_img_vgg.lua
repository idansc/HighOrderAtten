...
cmd:option('-image_root','/volatile/home/idansc@st.technion.ac.il/coco/images/','path to the image root')
cmd:option('-cnn_proto', '/home/idansc@st.technion.ac.il/idansc/lightStructAttention/image_model/VGG_ILSVRC_19_layers_deploy.prototxt', 'path to the cnn prototxt')
cmd:option('-cnn_model', '/home/idansc@st.technion.ac.il/idansc/lightStructAttention/image_model/VGG_ILSVRC_19_layers.caffemodel', 'path to the cnn model')
cmd:option('-batch_size', 10, 'batch_size')



cmd:option('-out_name_train', '/volatile/home/idansc@st.technion.ac.il/coco/vgg_features_val/vqa_data_img_vgg_train.h5', 'output name train')
cmd:option('-out_name_test', '/volatile/home/idansc@st.technion.ac.il/coco/vgg_features_val/vqa_data_img_vgg_test.h5', 'output name test')
...
cutorch.setDevice(opt.gpuid+1) -- lua uses 1-based indexing
