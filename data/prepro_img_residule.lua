...
cmd:text()
cmd:text('Options')
cmd:option('-input_json','vqa_data_prepro.json','path to the json file containing vocab and answers')
...
cmd:option('-out_name_train', 'cocoqa_data_img_residule_train.h5', 'output name')
cmd:option('-out_name_test', 'cocoqa_data_img_residule_test.h5', 'output name')
